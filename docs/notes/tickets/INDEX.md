...
| Ticket | Scope |
| --- | --- |
| [O_category-legend-hover-filter__20260922](O_category-legend-hover-filter__20260922.md) | Make function-category legend rows hover-preview, click-to-filter with multi-select, and add a reset. |
| [O_essentiality-go-iea-fallback__20260922](O_essentiality-go-iea-fallback__20260922.md) | Fall back on GO IEA annotations for essentiality context and surface discrepancies with UTEX/PCC annotations. Any active agent may pick this up when relevant to restructuring or reprioritizing. |
